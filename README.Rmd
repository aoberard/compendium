...
- [`R/`](https://github.com/aoberard/compendium/tree/main/R):
...
Launch the [`make.R`](https://github.com/aoberard/compendium/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/aoberard/compendium/blob/main/CONTRIBUTING.md).
